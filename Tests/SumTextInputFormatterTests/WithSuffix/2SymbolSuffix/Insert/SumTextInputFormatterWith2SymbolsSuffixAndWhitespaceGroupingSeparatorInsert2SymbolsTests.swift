//
//  SumTextInputFormatterWith2SymbolsSuffixAndWhitespaceGroupingSeparatorInsert2SymbolsTests.swift
//  AnyFormatKitTests
//
...
class SumTextInputFormatterWith2SymbolsSuffixAndWhitespaceGroupingSeparatorInsert2SymbolsTests: XCTestCase {
    ...
    func test12() {
      let actualResult = formatter.formatInput(
        ...
        replacementString: "89")
      let expectedResult = FormattedTextValue(formattedText: "12 345.67 $", caretBeginOffset: 11)
      XCTAssert(actualResult == expectedResult, "\n\(actualResult) must be equal to\n\(expectedResult)")
    }
}
