...
class StringCalculator {
    ...
    func unformattedRange(currentText: String, textPattern: String, from range: Range<String.Index>) -> Range<String.Index> {
        let numberOfFormatCharsBeforeRange = getNumberOfFormatChars(textPattern: textPattern, text: currentText, before: range.lowerBound)
        let numberOfFormatCharsInRange = getNumberOfFormatChars(textPattern: textPattern, text: currentText, in: range)
    ...
    private func getNumberOfFormatChars(textPattern: String, text: String, before: String.Index) -> Int {
    ...
    private func getNumberOfFormatChars(textPattern: String, text: String, in range: Range<String.Index>) -> Int {
